...
```
ghcr.io/skillrepos/aia-day1-devcontainer:latest
```
...
docker build --platform linux/amd64 -f .devcontainer/Dockerfile -t ghcr.io/skillrepos/aia-day1-devcontainer:latest .

# 3. Push to GHCR
docker push ghcr.io/skillrepos/aia-day1-devcontainer:latest
```
...
Go to: `github.com/orgs/skillrepos/packages/container/aia-day1-devcontainer/settings`
